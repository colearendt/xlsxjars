...
## Changes in version 0.9.0 (released 2025-07-02)
...
- Remove the `.onLoad` function from the package and add it to package xlsx. This is to help other dependencies on xlsxjars. See Issue 36
- Add clarification of license. All the code in the jar is not my work. The license and copyright is from The Apache Software Foundation
